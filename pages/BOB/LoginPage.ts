...
import { LoginPageLocators } from '../../locators/bob/LoginPageLocators';
...
export class LoginPage {
  ...
  static async enterUserID(page: Page) {
    ...
    await ElementHelper.clearAndEnterInTextField(page, UserIDEnter, bobTestData.loginDataFill.userId);
  ...
  static async enterUserPassword(page: Page) {
    ...
    await ElementHelper.clearAndEnterInTextField(page, userPasswordField, bobTestData.loginDataFill.userPassword);
