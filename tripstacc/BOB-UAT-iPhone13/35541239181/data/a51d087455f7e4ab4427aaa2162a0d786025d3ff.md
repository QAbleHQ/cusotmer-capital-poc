...
```
Error: Element '(//ul[@class="ui-menu ui-widget ui-widget-content ui-autocomplete ui-front" or @class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content customautocompleteHotel"]//li)[1]' was not visible after two attempts (including page refresh).
```
