export const HotelPageLocators = {
  ...
  hotelTab: `//li[@class=" t-hotel" or @class="active t-hotel"]//a`,
  ...
  datepicker: `//input[@id='hotel_daterange']`,
  nextvailablemonth:`(//th[@class='next available'])[1]`,
  Hotelbookingfromdate:`(//td[@class='available'])[12]`,
  Hotelbookingtodate:`(//td[@class='available'])[18]`,
  ...
  addButtonAfterAddingGuest: `//div[@class="add_btn_box"]//button`,
  ...
  redeemErrorMessage: `//h4[@class='err_title'])[2]`,
