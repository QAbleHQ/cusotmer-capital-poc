...
test('SC_015: Hotel Search', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
...
test('SC_015.01: Hotel Search - Domestic vs International Options', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
  await page.waitForTimeout(2500);
  await test.step('Step 1: Open Hotels Section', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.clickHotelTabBTN(page);
  ...
  await test.step('Step 5: Validate Domestic search results', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.getDomesticSearchResultTextandCompare(page);
    await page.waitForTimeout(2500);
  });
  ...
  await test.step('Step 10: Validate International search results', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.getInternationalSearchResultTextandCompare(page);
    await page.waitForTimeout(2500);
  });
});

test('SC_015.02: Verify Room Pricing - Single vs Multiple Rooms', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
  await page.waitForTimeout(2500);
  await test.step('Step 1: Open Hotels Section', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.clickHotelTabBTN(page);
...
test('SC_015.03: Search with custom Adult & Child combinations', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
  await page.waitForTimeout(2500);
  await test.step('Step 1: Open Hotels Section', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.clickHotelTabBTN(page);
...
test('SC_016: Filter/Sorting and Room Selection', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
  await page.waitForTimeout(2500);
  await test.step('Step 1: Open Hotels Section', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.clickHotelTabBTN(page);
...
test('SC_016.01: Update Search', { tag: ['@IDFC', '@Homepagehotel'] }, async () => {
  await page.waitForTimeout(2500);
  await test.step('Step 1: Open Hotels Section', async () => {
    await page.waitForTimeout(2500);
    await HotelHomePage.clickHotelTabBTN(page);
